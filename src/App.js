            ...
            {dictionary.word && (
                <ul>
                    <li className="word">
                        ...
                        <svg onClick={play} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                            <path
                                strokeLinecap="round"
                        ...
                        <audio id="audio" src={dictionary.phonetics[0].audio || dictionary.phonetics[1].audio}></audio>
                    </li>
